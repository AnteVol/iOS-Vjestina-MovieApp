...
class MovieCategoriesListController: UIViewController {
    ...
    func addMovies(films: [MovieAppData.MovieModel], stackViewToAdd: UIStackView) {
        for movie in films {
            ...
            heartButton.autoPinEdge(toSuperviewEdge: .top, withInset: 30)
            heartButton.autoPinEdge(toSuperviewEdge: .leading, withInset: 10)
        }
    }
    ...
    func constructHierarchyAndLayout() {
        ...
        popularLabel?.autoPinEdge(toSuperviewSafeArea: .leading, withInset: 20)
        ...
        trendingScrollView.autoPinEdge(toSuperviewSafeArea: .bottom)
